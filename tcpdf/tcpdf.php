...
class TCPDF {
	...
	public function Header() {
		...
		//	Aquests son els colors que utilitzo
			$this->SetTextColor(53, 76, 102);
		...
		// header string
		$this->SetFont($headerfont[0], $headerfont[1], $headerfont[2]-8);
		$this->SetX($header_x);


		//	Canvio els colors que utilitza el títol
		$this->SetTextColor(255, 154, 0);

		$this->MultiCell(0, $cell_height, $headerdata['string'], 0, '', 0, 1, '', '', true, 0, false);
		// print an ending header line
		
		//	Es pot canviar el color de la línia
		$this->SetLineStyle(array('width' => 0.85 / $this->getScaleFactor(), 'cap' => 'butt', 'join' => 'miter', 'dash' => 0, 'color' => array(53, 76, 102)));
	...
	public function Footer() {
		...
		//	Col·loco la línia de color blanc per que no aparegui
